...
Today, developers are on the front-lines dealing with errors and performance issues, but they are not equiped with the right tooling; "logs, metrics and traces" are not enough. You need 3 core concepts:
